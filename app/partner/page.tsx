...
export default function PartnerPage() {
    return (
        <div className="z-10 px-6 lg:px-44 w-full flex flex-col justify-center items-center gap-4">
            <SparklesText text="Partners" />
            <div className="mt-5 flex flex-wrap justify-center gap-5 md:gap-10">
            ...
            <div className="mt-20 w-full">
                <div className="p-2 border bg-white rounded-lg inline-block mb-2">
                    <span className="font-display opacity-70">Ready To Work With Us?🦾</span>
                </div>
                <PartnerForm />
            </div>
        </div>
