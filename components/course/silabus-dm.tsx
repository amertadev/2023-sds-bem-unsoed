...
let notifications = [
    {
        name: "Camp 1",
        description: "Pengenalan Digital, SEO, dan SEM",
        time: "15m ago",
        icon: "💸",
        color: "#00C9A7",
    },
    {
        name: "Camp 2",
        description: "Menulis dan Menyunting",
        time: "10m ago",
        icon: "👤",
        color: "#FFB800",
    },
    ...
    {
        name: "Camp 4",
        description: "Social Media Marketing Dasar",
        time: "2m ago",
        icon: "🗞️",
        color: "#1E86FF",
    },
    {
        name: "Camp 5",
        description: "Social Media Marketing Lanjutan",
        time: "1m ago",
        icon: "📈",
        color: "#F24E1E",
    },
